...
namespace WebBanGiay.Areas.NhanVienBanHang.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,Username,Email,PasswordHash,FullName,Phone,Address,DateOfBirth,Gender,PreferredSize,PreferredBrand,Newsletter,SMSNotification,IsActive,CreatedDate,LastLogin")] Customer customer)
        {
