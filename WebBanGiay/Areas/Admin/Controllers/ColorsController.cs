...
namespace WebBanGiay.Areas.Admin.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ColorID,ColorName,ColorCode,IsActive")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ColorID,ColorName,ColorCode,IsActive")] Color color)
        {
            if (ModelState.IsValid)
            {
