...
namespace WebBanGiay.Areas.Admin.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PaymentMethodID,MethodName,Description,IsActive")] PaymentMethod paymentMethod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentMethodID,MethodName,Description,IsActive")] PaymentMethod paymentMethod)
        {
            if (ModelState.IsValid)
            {
