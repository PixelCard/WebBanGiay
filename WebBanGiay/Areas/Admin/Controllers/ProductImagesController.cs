    ...
    public class ProductImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ImageID,ProductID,ImageURL,ImageType,DisplayOrder,IsActive,UploadedDate")] ProductImage productImage)
        {
            if (ModelState.IsValid)
            {
                ...
                if (string.IsNullOrEmpty(productImage.ImageType))
                {
                    productImage.ImageType = "Main"; // or whatever default your DB expects
                }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ImageID,ProductID,ImageURL,ImageType,DisplayOrder,IsActive,UploadedDate")] ProductImage productImage)
        {
            if (ModelState.IsValid)
            {
